...
var (
	...
	pattern_Query_Inflation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"squad", "mint", "v1beta1", "inflation"}, "", runtime.AssumeColonVerbOpt(false)))
)
