...
func (s *IntegrationTestSuite) TestCmdParams() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			`{"liquid_bond_denom":"bstake","whitelisted_validators":[],"unstake_fee_rate":"0.000000000000000000","commission_rate":"0.050000000000000000","min_liquid_staking_amount":"1000000"}`,
		},
		{
			"text output",
			[]string{},
