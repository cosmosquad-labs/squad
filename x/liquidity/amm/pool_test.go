...
func ExamplePoolsOrderBook() {
	...
	// +--------------------+------------------------------+--------------------+
	// +--------buy---------+------------price-------------+--------sell--------+
	// |                  0 |         1.012000000000000000 | 977                |
	// |                  0 |         1.011000000000000000 | 980                |
	// |                  0 |         1.010000000000000000 | 981                |
	// |                  0 |         1.009000000000000000 | 983                |
	// |                  0 |         1.008000000000000000 | 985                |
	// |                  0 |         1.007000000000000000 | 987                |
	// |                  0 |         1.006000000000000000 | 989                |
	// |                  0 |         1.005000000000000000 | 991                |
	// |                  0 |         1.004000000000000000 | 993                |
	// |                  0 |         1.003000000000000000 | 995                |
...
func ExamplePoolsOrderBook_EvenTicks() {
	...
	// +--------------------+------------------------------+--------------------+
	// +--------buy---------+------------price-------------+--------sell--------+
	// |             100070 |         0.999300000000000000 | 0                  |
	// |             100080 |         0.999200000000000000 | 0                  |
	// |             100090 |         0.999100000000000000 | 0                  |
	// |             100100 |         0.999000000000000000 | 0                  |
	// |             100110 |         0.998900000000000000 | 0                  |
	// |             100120 |         0.998800000000000000 | 0                  |
	// |             100130 |         0.998700000000000000 | 0                  |
	// +--------------------+------------------------------+--------------------+
}
