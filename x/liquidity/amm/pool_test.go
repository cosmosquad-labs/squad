...
func ExamplePoolsOrderBook() {
	...
	// Output:
	// +--------sell---------------------price----------------------buy---------+
	// |             989090 |         1.006000000000000000 | 0                  |
	// |             991061 |         1.005000000000000000 | 0                  |
	// |             993037 |         1.004000000000000000 | 0                  |
	// |             995019 |         1.003000000000000000 | 0                  |
	// |             997007 |         1.002000000000000000 | 0                  |
	// |             999000 |         1.001000000000000000 | 0                  |
	// |                  0 |         1.000000000000000000 | 0                  |
	// |                  0 |         0.999900000000000000 | 100010             |
	// |                  0 |         0.999800000000000000 | 100020             |
	// |                  0 |         0.999700000000000000 | 100030             |
	// |                  0 |         0.999600000000000000 | 100040             |
	// |                  0 |         0.999500000000000000 | 100050             |
	// |                  0 |         0.999400000000000000 | 100060             |
	// +------------------------------------------------------------------------+
	// +--------sell---------------------price----------------------buy---------+
	// |             995019 |         1.003000000000000000 | 0                  |
	// |             997007 |         1.002000000000000000 | 0                  |
	...
	// |                  0 |         0.999000000000000000 | 1001001            |
	...
	// |                  0 |         0.998000000000000000 | 1002004            |
	...
	// |                  0 |         0.997000000000000000 | 1003009            |
	// +------------------------------------------------------------------------+
}
