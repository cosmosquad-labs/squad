...
type QueryOrderBooksRequest struct {
	...
	TickPrecisions []uint32 `protobuf:"varint,3,rep,packed,name=tick_precisions,json=tickPrecisions,proto3" json:"tick_precisions,omitempty"`
}
...
func (*QueryOrderBooksRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b0c61a0bed7a769, []int{25}
}
...
func (m *QueryOrderBooksRequest) GetPairId() uint64 {
	if m != nil {
		return m.PairId
	}
	return 0
...
func (m *QueryOrderBooksRequest) GetTickPrecisions() []uint32 {
	if m != nil {
		return m.TickPrecisions
	}
	return nil
}
...
type QueryOrderBooksResponse struct {
	BasePrice  github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=base_price,json=basePrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"base_price"`
	OrderBooks []OrderBookResponse                    `protobuf:"bytes,2,rep,name=order_books,json=orderBooks,proto3" json:"order_books"`
}
...
func (*QueryOrderBooksResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b0c61a0bed7a769, []int{26}
}
...
func (m *QueryOrderBooksResponse) GetOrderBooks() []OrderBookResponse {
	if m != nil {
		return m.OrderBooks
	}
	return nil
...
func (*PoolResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b0c61a0bed7a769, []int{27}
}
...
type OrderBookResponse struct {
	TickPrecision uint32                  `protobuf:"varint,1,opt,name=tick_precision,json=tickPrecision,proto3" json:"tick_precision,omitempty"`
	Ticks         []OrderBookTickResponse `protobuf:"bytes,2,rep,name=ticks,proto3" json:"ticks"`
}
...
func (*OrderBookResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b0c61a0bed7a769, []int{28}
}
...
func (m *OrderBookResponse) GetTickPrecision() uint32 {
	if m != nil {
...
func (m *OrderBookResponse) GetTicks() []OrderBookTickResponse {
	if m != nil {
		return m.Ticks
	}
	return nil
...
type OrderBookTickResponse struct {
	...
	Buy   OrderBookSideResponse                  `protobuf:"bytes,2,opt,name=buy,proto3" json:"buy"`
	Sell  OrderBookSideResponse                  `protobuf:"bytes,3,opt,name=sell,proto3" json:"sell"`
}
...
func (*OrderBookTickResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b0c61a0bed7a769, []int{29}
}
...
func (m *OrderBookTickResponse) GetBuy() OrderBookSideResponse {
	if m != nil {
		return m.Buy
	}
	return OrderBookSideResponse{}
}

func (m *OrderBookTickResponse) GetSell() OrderBookSideResponse {
	if m != nil {
		return m.Sell
	}
	return OrderBookSideResponse{}
...
type OrderBookSideResponse struct {
	UserOrderAmount github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=user_order_amount,json=userOrderAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"user_order_amount"`
	PoolOrderAmount github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=pool_order_amount,json=poolOrderAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"pool_order_amount"`
}

func (m *OrderBookSideResponse) Reset()         { *m = OrderBookSideResponse{} }
func (m *OrderBookSideResponse) String() string { return proto.CompactTextString(m) }
func (*OrderBookSideResponse) ProtoMessage()    {}
func (*OrderBookSideResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3b0c61a0bed7a769, []int{30}
}
func (m *OrderBookSideResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OrderBookSideResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OrderBookSideResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OrderBookSideResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OrderBookSideResponse.Merge(m, src)
}
func (m *OrderBookSideResponse) XXX_Size() int {
	return m.Size()
}
func (m *OrderBookSideResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_OrderBookSideResponse.DiscardUnknown(m)
}

var xxx_messageInfo_OrderBookSideResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*QueryOrdersByOrdererRequest)(nil), "squad.liquidity.v1beta1.QueryOrdersByOrdererRequest")
	proto.RegisterType((*QueryOrderBooksRequest)(nil), "squad.liquidity.v1beta1.QueryOrderBooksRequest")
	proto.RegisterType((*QueryOrderBooksResponse)(nil), "squad.liquidity.v1beta1.QueryOrderBooksResponse")
	proto.RegisterType((*PoolResponse)(nil), "squad.liquidity.v1beta1.PoolResponse")
	proto.RegisterType((*OrderBookResponse)(nil), "squad.liquidity.v1beta1.OrderBookResponse")
	proto.RegisterType((*OrderBookTickResponse)(nil), "squad.liquidity.v1beta1.OrderBookTickResponse")
	proto.RegisterType((*OrderBookSideResponse)(nil), "squad.liquidity.v1beta1.OrderBookSideResponse")
}
...
var fileDescriptor_3b0c61a0bed7a769 = []byte{
	...
	,
}
...
func (c *queryClient) OrdersByOrderer(ctx context.Context, in *QueryOrdersByOrdererRequest, opts ...grpc.CallOption) (*QueryOrdersResponse, error) {
	out := new(QueryOrdersResponse)
	err := c.cc.Invoke(ctx, "/squad.liquidity.v1beta1.Query/OrdersByOrderer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) OrderBooks(ctx context.Context, in *QueryOrderBooksRequest, opts ...grpc.CallOption) (*QueryOrderBooksResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/squad.liquidity.v1beta1.Query/OrderBooks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_OrdersByOrderer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/squad.liquidity.v1beta1.Query/OrdersByOrderer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_OrderBooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/squad.liquidity.v1beta1.Query/OrderBooks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryOrderBooksRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TickPrecisions) > 0 {
		dAtA19 := make([]byte, len(m.TickPrecisions)*10)
		var j18 int
		for _, num := range m.TickPrecisions {
			for num >= 1<<7 {
...
func (m *OrderBookResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TickPrecision != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.TickPrecision))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *OrderBookTickResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1a
	{
		size, err := m.Buy.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *OrderBookSideResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OrderBookSideResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OrderBookSideResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryOrderBooksRequest) Size() (n int) {
	...
	if len(m.TickPrecisions) > 0 {
		l = 0
		for _, e := range m.TickPrecisions {
			l += sovQuery(uint64(e))
		}
...
func (m *OrderBookResponse) Size() (n int) {
	...
	_ = l
	if m.TickPrecision != 0 {
		n += 1 + sovQuery(uint64(m.TickPrecision))
	}
	if len(m.Ticks) > 0 {
...
func (m *OrderBookSideResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				m.TickPrecisions = append(m.TickPrecisions, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.TickPrecisions) == 0 {
					m.TickPrecisions = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field TickPrecisions", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
...
func (m *OrderBookResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Ticks = append(m.Ticks, OrderBookTickResponse{})
...
func (m *OrderBookTickResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.Buy.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *OrderBookSideResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OrderBookSideResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OrderBookSideResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
