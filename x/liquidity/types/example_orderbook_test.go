...
func ExampleMakeOrderBookResponse_pool() {
	...
	// |            1307013 |         0.989000000000000000 |                    |
	// |------------------------------------------------------------------------|
	// |                              0.988000000000000000                      |
	// |------------------------------------------------------------------------|
	// |                    |         0.988000000000000000 | 1521179            |
	// |                    |         0.985000000000000000 | 1520416            |
	// |                    |         0.982000000000000000 | 1671597            |
	// |                    |         0.979000000000000000 | 1672615            |
	// +------------------------------------------------------------------------+
}
...
func ExampleMakeOrderBookResponse_userOrder() {
	...
	// |                    |         1.324000000000000000 | 255217323          |
	// |                    |         1.323000000000000000 | 255506641          |
	// |                    |         1.322000000000000000 | 255796507          |
	// |                    |         1.321000000000000000 | 256086919          |
	// |                    |         1.320000000000000000 | 367377883          |
	// |                    |         1.319000000000000000 | 256669401          |
	// |                    |         1.318000000000000000 | 256961469          |
	// |                    |         1.317000000000000000 | 257254091          |
	// |                    |         1.316000000000000000 | 368543352          |
	// +------------------------------------------------------------------------+
}
...
func ExampleMakeOrderBookResponse_edgecase1() {
	...
	// |              59172 |         0.953000000000000000 |                    |
	// |------------------------------------------------------------------------|
	// |                              0.952980000000000000                      |
	// |------------------------------------------------------------------------|
	// |                    |         0.952900000000000000 | 425398             |
	// |                    |         0.952800000000000000 | 415669             |
	// |                    |         0.952700000000000000 | 518993             |
	// |                    |         0.952600000000000000 | 503626             |
	// |                    |         0.952500000000000000 | 408370             |
	// |                    |         0.952400000000000000 | 503686             |
	// |                    |         0.952300000000000000 | 454528             |
	// |                    |         0.952200000000000000 | 503942             |
	// |                    |         0.952100000000000000 | 408636             |
	// |                    |         0.952000000000000000 | 504005             |
	// +------------------------------------------------------------------------+
}
