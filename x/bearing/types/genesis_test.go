...
func TestValidateGenesis(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			"bearing1: duplicate bearing name",
		},
		{
			"invalid bearing name case",
			func(genState *types.GenesisState) {
				genState.Params = types.DefaultParams()
			...
			"invalid name: bearing name only allows letters, digits, and dash(-) without spaces and the maximum length is 50",
		},
		{
