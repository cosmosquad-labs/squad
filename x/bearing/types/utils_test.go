...
func TestDeriveAddress(t *testing.T) {
	testCases := []struct {
		...
		{
			// http://127.0.0.1:1317/cosmos/bearing/v1beta1/addresses/fee_collector?type=1
		...
		{
			// http://127.0.0.1:1317/cosmos/bearing/v1beta1/addresses/GravityDEXFarmingBearing?module_name=farming
			types.AddressType32Bytes,
			"farming",
			"GravityDEXFarmingBearing",
			"cosmos1228ryjucdpdv3t87rxle0ew76a56ulvnfst0hq0sscd3nafgjpqqkcxcky",
		},
		{
			// http://127.0.0.1:1317/cosmos/bearing/v1beta1/addresses/?module_name=bearing&type=1
			types.AddressType20Bytes,
			types.ModuleName,
			"",
		...
		{
			// http://127.0.0.1:1317/cosmos/bearing/v1beta1/addresses/test1?module_name=bearing&type=1
			types.AddressType20Bytes,
			types.ModuleName,
			"test1",
		...
		{
			// http://127.0.0.1:1317/cosmos/bearing/v1beta1/addresses/test1?module_name=bearing&type=0
			types.AddressType32Bytes,
			types.ModuleName,
			"test1",
		...
		{
			// http://127.0.0.1:1317/cosmos/bearing/v1beta1/addresses/?module_name=test2
			types.AddressType32Bytes,
			"test2",
			"",
