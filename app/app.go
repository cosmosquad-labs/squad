...
func NewFarmingApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		evidencetypes.StoreKey, liquiditytypes.StoreKey,
		capabilitytypes.StoreKey, feegrant.StoreKey, authzkeeper.StoreKey, budgettypes.StoreKey, farmingtypes.StoreKey,
	)
